...
import { configurarCargarLote, cargarParcelaEnFormLote, bboxDelMapaVisible } from "./cargar-lote.js";
import {
  initializeApp,
  deleteApp
...
function algunaHojaAbierta() {
  return [elFicha, document.getElementById("form-lote")].some((el) => !el.classList.contains("oculto"));
}
